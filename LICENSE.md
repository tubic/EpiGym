...
Attribution: identify the reused material as EpiGym v1.2 and retain this notice.
...
| MAAD antibody–variant neutralization | community compilation | per source; source table not bundled |
...
The MAAD source table is intentionally excluded from this archive. It is available from
the upstream download page documented in `README.md` and `DATASHEET.md`.
